...
DECLARED_DEBT = {
    ...
    "check_prose_rate.py":
        ...
        "LENGTH, the one red criterion. paper2/body.tex is 10,182 words against 11,131 at the start of the pass: 949 "
        "removed, 8.5 per cent, against a 25 per cent target of 8,349. The author accepted roughly "
        ...
        "content. A near-duplicate search over all 407 sentences -- Jaccard over the set of "
        ...
        "the remaining 1,833 words were not taken, each figure measured: every sentence in the file "
        ...
        "1,911 words are recorded concessions, where deleting one is a retraction rather "
        "than a cut.\n"
        ...
        "added on the author's decision: paper2/body.tex 6 of 407 sentences (1.47%) against a "
        "ceiling of 8 at digest fc9b155e, paper2/si.tex 22 of 1163 (1.89%) against 24 at digest "
        "3ea86bb6, where the corpus runs at 18 of 1,841 sentences, 0.98%. BOTH HALVES ARE NOW "
