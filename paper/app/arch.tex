...
computation at every candidate at inference. Accuracy and cost point the same way. The merged-graph
variant is implemented and available; we do not deploy it because it loses on both counts.
...
by element; the anchor must cover at least 40\% of the smaller molecule's atoms. From that
