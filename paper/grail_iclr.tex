...
a methodological decision that this field reports rarely and has never varied. The same quantity also
...
That comparison rests on an assumption this field has not examined. Computing recall requires a
...
stereochemistry removed, or as molecular fingerprints. These criteria disagree, most importantly about tautomers,
alternative structures of one compound differing in the position of a mobile hydrogen atom.
Evaluations in this field adopt one each, usually without stating why, and none has asked what a
different one would do to the ordering. That question has been answered elsewhere in the
affirmative, which is why it is worth asking here.
...
Attributing a recall figure to a stage of the pipeline is likewise possible. Splitting coverage
from ranking is not new in this field, and our contribution is to make the split exact, to separate
selection from ranking within it, and to note that it rests on the first contribution: the factors
count matched references, so a decomposition computed under an unstated criterion inherits that
arbitrariness at every stage. The decomposition introduced here requires no additional experiments, applies to any
