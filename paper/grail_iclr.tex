...
matching; largest missing class $6\%$ ($n{=}500$) \\
\addlinespace
...
locate recoverable recall at the selection stage --- the gap to the frequency prior and the gain
from widening selection --- and the third characterises what the bank cannot reach in one step.
