...
We address both problems. We introduce TAME (tautomer-aware metabolite
evaluation), a protocol for metabolite-structure prediction that comprises tautomer-aware
structure matching, a leakage-audited data split, and a
...
$[-0.196,-0.065]$; under tautomer matching that advantage disappears entirely and the
...
selector reaches $0.266$ while ranking by the empirical rule-firing frequency alone reaches $0.410$, a paired difference of $\mathbf{-0.144}$ (95\% CI $[-0.196,\,-0.095]$, $n=245$). The learned selector underperforms the frequency baseline. Under positive-unlabelled annotation with an approximately constant labelling
