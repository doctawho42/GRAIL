...
selection & $|C_{\text{bud}}|/|C_{\text{full}}|$ & \textbf{\selret}  & $[0.343,\,0.393]$ \\
ranking   & $|H|/|C_{\text{bud}}|$           & \textbf{0.963}    & $[0.946,\,0.978]$ \\
\midrule
...
reaches the output. Coverage sits between them. The decomposition therefore points at selection,
and specifically at how few rules are applied, as the stage where intervention is warranted. It also bounds what this architecture can achieve: even a perfect selector and a perfect
