...
pipeline converts only $35.5\%$ of its own ceiling into realised recall, and the largest single shortfall is \textbf{selection}: less than half of what the bank can reach survives into the
...
point estimate reverses ($+0.005$, n.s.). A criterion chosen for convenience can therefore erase a
...
$0.344 \pm 0.010$ on that split. SyGMa reaches \textbf{0.572}, a paired difference of $-0.242$ from GRAIL
