...
of the deployed configuration, with selection done on validation. Some \emph{exploratory} analyses
in Appendix~\ref{app:negative} were scored on test before we tightened this discipline; they inform
no headline claim and their conclusions are negative.
