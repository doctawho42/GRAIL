...
MetaPredictor and G for GLORYx. The row beneath names the GRAIL arm, \emph{int.} or \emph{exh.},
...
\numBoundShortfallsharemax{} are of a type the training annotation never holds. That is a bound, not a point, and Section~\ref{SI-sec:si-typeoverlap} gives the counts it rests on.
...
file names no producer and records no seed, so it stands outside the provenance apparatus the rest
of this work is held to, and the figure is quoted here with that weakness named.
