...
turns to its limit. On validation, raising it to the whole bank is worth
$+\numBudgetKSevenFiveEightOneGapthirty$
$[+\numBudgetKSevenFiveEightOneLothirty, +\numBudgetKSevenFiveEightOneHithirty]$ at an output
budget of thirty, and nothing that separates at fifteen (Section~\ref{SI-sec:si-budget}). Either way it pays
