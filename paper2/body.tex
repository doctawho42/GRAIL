...
swept for SyGMa, whose scenario is a documented setting, and the lead survives it. BioTransformer's step count is also ours to turn and was not
...
(Section~\ref{SI-sec:si-comparators}). For those two the difference between the arms stands, and the wide-budget cells should be read with it in view.
