# MetaTox submission set (879 substrates, GRAIL test-1170 split)

Purpose: the Phase 2 MetaTox column on all 1,170 evaluated substrates.
GRAIL already has ranked predictions for all 879 of these substrates.
...
257 of 879 were re-tautomerized from GRAIL's internal form for chemically-sane submission;
each is guaranteed the same molecule as its eval key under our tautomer-InChIKey matching.

## What to run in MetaTox
Predict metabolites (Phase I + Phase II as MetaTox offers) for each of the 879 substrates.
...
Notes: 257 of 879 re-tautomerized for submission (identity preserved under tautomer-InChIKey).
